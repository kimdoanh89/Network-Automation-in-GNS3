...
- [Setup lab for Network Automation in GNS3](INE-Python-Network-Automation/01_Lab_setup.ipynb)
- [Advantages of network automation](INE-Python-Network-Automation/02_advantages_of_network_automation.ipynb)
...
- [Configuration of CSR1000v notebook](Network-Management-Netconf/00_csr1000v_in_gns3.ipynb)
